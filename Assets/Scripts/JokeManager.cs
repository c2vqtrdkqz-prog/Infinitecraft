...
{
    [Header("UI (assign one pair: Unity UI Text OR TextMeshProUGUI)")]
    public Button fetchButton;

    // Unity UI Text fields (legacy)
    public Text setupText;
    public Text punchlineText;
    public Text statusText;

    // TextMeshPro fields (recommended)
    ...
    {
        // Set TextMeshPro if present
        if (setupTMP != null) setupTMP.text = joke.setup;
        if (punchlineTMP != null) punchlineTMP.text = joke.punchline;

        // Set Unity UI Text if present
        if (setupText != null) setupText.text = joke.setup;
        if (punchlineText != null) punchlineText.text = joke.punchline;
    }
    ...
    void ClearJoke()
    {
        ...
        if (setupText != null) setupText.text = "";
        if (punchlineText != null) punchlineText.text = "";
    }
